...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("John", LocalDate.of(2000, 10, 12), Qualification.Graduate, "9858585843",
				"john@lti.com", "Mumbai");
		Student student2 = new Student("Mike", LocalDate.of(2001, 9, 15), Qualification.Masters, "6785585843",
		...
		Course course3=new Course("Azure", 8, 8000, Qualification.Masters);
		...
		Student student= dao.findStudentByRollNo(rollNo1);
		if(student!=null) {
		...
		Student student12 = dao.findStudentByRollNo(rollNo2);
		if (student12 != null) {
			System.out.println("Enter phone no:");
			String phoneNo = scanner.next();
			student.setPhoneNo(phoneNo);
			dao.updateStudentProfile(student12); // DAO method
		} else {
			System.out.println("Student not found.");
		} 
